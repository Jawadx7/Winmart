    ...
    <div className="header flex justify-between align-center">
      ...
      <div className="filter flex space-x-3 align-center">
        ...
        <div className="search bg-gray-100 border-2 rounded-full flex justify-center align-center">
          <input
            type="text"
            placeholder="search"
            className="px-2 py-1 outline-none rounded-full bg-transparent hmd"
          />
      ...
      <div className="nav">
        ...
        <ul className="text-right">
          <li className="flex align-center justify-end">
            <span>Food App</span>{" "}
            <img src={food} alt="" className="w-10 h-10" />
          </li>
          <li>Accessories</li>
          <li>Laptops</li>
          <li>Watch</li>
      ...
      <div id="nav2" className={navStatus === "opened" ? "opened" : "closed"}>
        ...
        <button className="btn mb-5">SIGN UP FREE</button>
        <ul className="text-right">
          <li className="flex align-center justify-end hover:text-orange-500">
            <span>Food App</span>{" "}
            <img src={food} alt="" className="w-10 h-10" />
          </li>
          <li>Accessories</li>
      ...
      <div className="menuBtn" onClick={() => showNav()}>
        <RiMenu4Fill />
      </div>
    </div>
  );
